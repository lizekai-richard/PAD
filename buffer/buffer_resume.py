...
def train(pid, args, channel, num_classes, im_size, trainloader, images_all, labels_all,
    ...
    if args.resume and os.path.exists(args.checkpoint):
        trajectories = torch.load(os.path.join(args.checkpoint, "buffer{}.pt".format(pid)))

    for it in range(10 - len(trajectories)):
        ...
        torch.save(trajectories, os.path.join(args.checkpoint, "buffer{}.pt".format(pid)))
